...
namespace Polygon.Core
{
    ...
    {
        public ReadOnlyMemory<Point> GetIntersectedPolygon(in ReadOnlyMemory<Point> subjectPoly, in ReadOnlyMemory<Point> clipPoly) =>
                GetIntersectedPolygon(subjectPoly.Span, clipPoly.Span);
        ...
        public ReadOnlyMemory<Point> GetIntersectedPolygon(in ReadOnlySpan<Point> subjectPoly, in ReadOnlySpan<Point> clipPoly)
        {
